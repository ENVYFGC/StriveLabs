...
public:
  ...
  FIELD(0x60, int, P1Tension);
  FIELD(0x158, int, P1TensionPenalty);
  FIELD(0x164, int, P1TensionPulse);
  FIELD(0x170, int, P1Danger);
  FIELD(0x178, int, P1PositiveBonus);
  FIELD(0x1F8, int, P2Tension);
  FIELD(0x2F0, int, P2TensionPenalty);
  FIELD(0x2FC, int, P2TensionPulse);
  FIELD(0x308, int, P2Danger);
  FIELD(0x310, int, P2PositiveBonus);
  FIELD(0x14C8, int, P1BurstRaw);
  FIELD(0x14CC, int, P2BurstRaw);
